...
export const global_elements = {
  header: `<div class="container px-4"><div class="site-logo"><img src="assets/images/morelearning.webp" alt="Morelearning logo"></div><nav class="navigation"><ul><li><a href="#">ABOUT</a></li><li class="under-sub-menu"><span>SERVICES<span class="sub-menu-arrow"></span></span><ul class="sub-menu"><li><a href="#"><span class="corporate-video-icon"></span>Corporate Video Solutions</a></li><li><a href="#"><span class="animation-video-icon"></span>Animated Video Solutions</a></li><li><a href="#"><span class="product-video-icon"></span>Marketing Video Solutions</a></li><li><a href="#"><span class="social-media-video-icon"></span>Educational and Training Solutions</a></li></ul></li><li><a href="#">PORTFOLIO</a></li><li><a href="#">BLOG</a></li><li><a href="#">CONTACT</a></li></ul></nav><div class="mobile-menu"><span></span><span></span><span></span></div></div>`,
