...
export const global_elements = {
  header: `<div class="container px-4"><div class="site-logo"><img src="assets/images/morelearning.webp" alt="Morelearning logo"></div><nav class="navigation"><ul><li><a href="#">ABOUT</a></li><li class="under-sub-menu"><span>SERVICES<span class="sub-menu-arrow"></span></span><ul class="sub-menu"><li><a href="#"><span class="custom-elearning-development"></span>Custom elearning development</a></li><li><a href="#"><span class="rapid-elearning"></span>Rapid elearning</a></li><li><a href="#"><span class="Mobile-elearning"></span>Mobile elearning</a></li><li><a href="#"><span class="explainer-videos"></span>Explainer Videos</a></li><li><a href="#"><span class="simulation-and-game-based-learning"></span>Simulation & Game Based learning</a></li><li><a href="#"><span class="translation-and-localigation"></span>Translation & Localigation</a></li><li><a href="#"><span class="classroom-and-Face-to-face-training-to-elearning"></span>Classroom and Face-to-face training to eLearning</a></li><li><a href="#"><span class="LMS-development-and-management"></span>LMS development and management</a></li><li><a href="#"><span class="flash-to-HTML5-conversion"></span>Flash to HTML5 conversion</a></li><li><a href="#"><span class="arvr-360-learning-experiences"></span>AR/VR & 360 learning experiences</a></li><li><a href="#"><span class="elearning-and-training-consultancy"></span>eLearning and training consultancy</a></li><li><a href="#"><span class="outsourced-learning-development"></span>Outsourced learning & development</a></li></ul></li><li><a href="#">PORTFOLIO</a></li><li><a href="#">BLOG</a></li><li><a href="#">CONTACT</a></li></ul></nav><div class="mobile-menu"><span></span><span></span><span></span></div></div>`,
